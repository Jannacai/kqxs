                ...
                <nav className={styles.navbar}>
                    <div className="container">
                        <ul className={styles.nav_list}>
                            ...
                            <li className={`${styles.nav_item} ${router.pathname.startsWith('/tao-dan-de-dac-biet') ? styles.active : ''}`}>
                                <div className={styles.grouplink}>
                                    <Link href="/tao-dan-de-dac-biet/" className={styles.nav_itemLink}>Tạo Dàn</Link>
                                    <span className={styles.icon}><i className="fa-solid fa-chevron-down"></i></span>
                                </div>
                                <ul className={styles.nav__menu}>
                                    <li><Link className={styles.nav_menuLink} href="/tao-dan-de-dac-biet/">Tạo Nhanh Dàn Đặc Biệt </Link></li>
                                    <li><Link className={styles.nav_menuLink} href="/taodande/dan-2d/tao-dan-de-2d">Tạo Dàn 2D</Link></li>
                                    <li><Link className={styles.nav_menuLink} href="/taodande/dan-3d4d/tao-dan-de-3d4d">Tạo Dàn 3D-4D</Link></li>
                                    <li><Link className={styles.nav_menuLink} href="/taodande/tao-dan-ngau-nhien9x0x/">Tạo Dàn 9X0X Ngẫu Nhiên</Link></li>
                                </ul>
                            </li>
