...
export default function Document() {
    const defaultImage = "https://xsmb.win/default-og-image.jpg"; // Hình ảnh 1200x630px
    const defaultDescription = "Cập nhật nhanh kết quả xổ số và tin tức mới nhất tại XSMB.WIN.";
    const defaultTitle = "XSMB.WIN - Kết quả xổ số và tin tức";
