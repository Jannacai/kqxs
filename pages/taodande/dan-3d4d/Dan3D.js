...
const Dan3D = () => {
    ...
    const debouncedFetchLevels = useCallback(
        debounce(async (value) => {
            setLoading(true);
            try {
                const response = await fetch(`${API_BASE_URL}/api/taodan/taodan3D`, {
                    method: 'POST',
    ...
    return (
        <dispatchEvent>
            <div className={styles.form}>
                <h1 className={styles.title}>Tạo Dàn 3D</h1>
                <div className={`${styles.formGroup} ${styles.fullWidth}`}>
                    ...
                    <textarea
                        ...
                        placeholder="Ví dụ: 123,456,51278,910263 (dùng , ; hoặc cách)"
                ...
                <div className={styles.formGroup}>
                    ...
                    <div className={styles.buttonGroup}>
                        <button className={`${styles.filterButton}`}>Tạo Dàn 3D</button>
                        <button
                            onClick={xoaDan}
            ...
            <div className={`${styles.modal} ${showCopyModal ? styles.active : ''}`} onClick={closeModal}>
                <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
                    <p className={styles.modalMessage}>
                        ...
                        {copyDanClicked && 'Đã sao chép dàn số 3D'}
